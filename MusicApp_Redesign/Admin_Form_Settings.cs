...
{
    public partial class Admin_Form_Settings : Form
    {
        public Admin_Form_Settings()
        {
            InitializeComponent();
        }
        ...
        {
            Properties.Settings.Default.AdminBackcolor = panel_MenuTest.BackColor;
            Properties.Settings.Default.AdminForecolor = label_LogoTest.ForeColor;
        ...
        private void button_RefreshColors_Click(object sender, EventArgs e)
        {
            ...
            label_LogoTest.ForeColor = Properties.Settings.Default.AdminForecolor;
            label_WelcomeTest.ForeColor = Properties.Settings.Default.AdminForecolor;
        }
    }
}
